...
import { X, Package, MapPin, Calendar, Clock, Ship, User, Phone, CheckCircle, Truck, AlertCircle } from 'lucide-react';
        ...
        {packageData ? (
          <div>
            ...
            <div className="flex items-start justify-between gap-3 pr-8 mb-4 border-b border-slate-100 pb-3">
              <div>
                <span className="text-[10px] font-semibold uppercase text-slate-400 tracking-wider">Nomor Resi</span>
            ...
            <div className="grid grid-cols-2 gap-3 bg-slate-50 p-3.5 rounded-xl border border-slate-200 text-xs mb-4">
              <div>
                <p className="text-slate-500 text-[10px]">Tujuan Pengiriman</p>
              ...
              <div>
                <p className="text-slate-500 text-[10px]">Berat & Est. Biaya</p>
                <p className="font-bold text-slate-900 mt-0.5">
                  {packageData.weightKg} kg (Rp {packageData.totalCost.toLocaleString('id-ID')})
                </p>
              </div>
              <div>
                <p className="text-slate-500 text-[10px]">Penerima</p>
              ...
              <div>
                <p className="text-slate-500 text-[10px]">Kapal / Armada</p>
            ...
            <div className="bg-red-50 border border-red-200 p-3 rounded-xl mb-4 text-xs flex items-start gap-2.5">
              ...
              <div>
                <p className="font-semibold text-red-900">Lokasi Terkini:</p>
                ...
                <p className="text-[10px] text-red-700 mt-1 flex items-center gap-1">
                  ...
                  Estimasi Sampai: {packageData.estimatedArrival}
                </p>
              </div>
            </div>
          ...
          <div className="text-center py-6">
            ...
            <h3 className="text-base font-bold text-slate-900 mb-1">Resi Tidak Ditemukan</h3>
            <p className="text-xs text-slate-500 max-w-xs mx-auto mb-4">
              Resi <span className="font-mono text-red-600 font-bold">{searchedResi}</span> belum terdaftar di sistem. Silakan periksa kembali atau hubungi CS kami.
            </p>
            <button
              onClick={onClose}
